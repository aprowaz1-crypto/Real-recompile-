// realrecompile - ReXGlue Recompiled Project
...
class RealrecompileApp : public rex::ui::WindowedApp, public rex::ui::WindowListener {
public:
    static std::unique_ptr<rex::ui::WindowedApp> Create(rex::ui::WindowedAppContext& ctx) {
        return std::make_unique<RealrecompileApp>(ctx);
    }

    RealrecompileApp(rex::ui::WindowedAppContext& ctx)
        : WindowedApp(ctx, "realrecompile", "[game_directory]") {
    ...
    bool OnInitialize() override {
        ...
        REXLOG_INFO("realrecompile starting");
        ...
        // Create window
        window_ = rex::ui::Window::Create(app_context(), "realrecompile", 1280, 720);
        if (!window_) {
...
XE_DEFINE_WINDOWED_APP(realrecompile, RealrecompileApp::Create)
